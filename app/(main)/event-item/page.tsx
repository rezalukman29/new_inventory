  ...
  const dataviewGridItem = (item: any, isCart: boolean) => {
    return (
      <div className="col-12 sm:col-6 md:col-4 lg:col-3">
        <div className="card m-2 border-1 surface-border px-2 py-3">
          <img
            src={
              isValidUrl(item.photo)
                ? item.photo
          ...
          <div style={{ backgroundColor: "#F7F7F7", padding: 8 }}>
            <div className="flex align-items-start justify-content-between mb-3">
              <div className="flex flex-row align-items-center">
                <Icon icon="si:pin-alt-2-line" color="#000" className="mr-2" />
                <Text
                  label={item.subArea}
                  variant="base"
                  fontWeight="semi-bold"
            ...
            <div className="mt-3 flex flex-col gap-x-4 mb-2">
            ...
            <div className="flex flex-row mb-2">
              ...
              <p className="ml-2">
                {item.scan_in === 0
                  ? "Scan In"
                  : `Scanned In at ${moment(item.scan_in_date as any)
                      .add(
                        Number(
                          item.scan_in_date
                            .split("+")
            ...
            <div className="flex flex-row mb-2">
              ...
              <p className="ml-2">
                {item.scan_out === 0
                  ? "Scan Out"
                  : `Scanned Out at ${moment(item.scan_out_date as any)
                      .add(
                        Number(
                          item.scan_in_date
                            .split("+")
